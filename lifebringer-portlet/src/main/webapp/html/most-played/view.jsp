...
<%
String sql = "SELECT {u.*}, count(lgs.gameScore) as value FROM lifebringer_GameScore as lgs INNER JOIN User_ as u ON lgs.userId = u.userId  WHERE lgs.groupId = ? GROUP BY u.userId ORDER BY value DESC";
%>
<h1>Most played players</h1>
